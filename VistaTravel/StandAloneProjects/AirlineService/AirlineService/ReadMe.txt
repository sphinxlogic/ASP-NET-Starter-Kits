========================================================================
       ATL SERVER : AirlineService Project Overview
========================================================================

AppWizard has created this AirlineService application for you.  This application
not only demonstrates the basics of using the ATL Server Classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your AirlineService application.

AirlineService.vcproj
